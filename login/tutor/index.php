...
<head>
    ...
    <title>CariPrivatYuk! - Login Tutor</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a href="/KitaKursusKuy-PWEB/login" class="nav-link dropdown-toggle"
                            id="navbarDropdownBlog">Login <span class="caret"></span></a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                            <a class="dropdown-item" href="/KitaKursusKuy-PWEB/login/user">User</a>
                            <a class="dropdown-item active" href="/KitaKursusKuy-PWEB/login/tutor">Tutor</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="/KitaKursusKuy-PWEB/register" class="nav-link dropdown-toggle"
    ...
    <div class="container py-5 mt-5 " style="height:100vh" id="login-area">
        <div class="row login child-div mt-5 pt-5">
            <div class="col-lg-6">
                <img class="card-img" src="../../assets/main_resources/imgs/jumbotron1.jpeg" alt="" height="270px">
            </div>
            <div class="col-lg-3 parent-div">
                <div class="row child-div">
                    <div class="col-12">
                        <h3 id="login1" style="font-weight: bold;">Login Tutor</h3>
                        <form>
                            ...
                            <div class="form-group">
                                Belum punya akun? <a href="/KitaKursusKuy-PWEB/register/tutor"> daftar disini </a>
                            </div>
