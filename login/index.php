...
<div class="ribbon-yellow pt-5 pb-5">
    <p>Kalian yang sedang mencari tutor dan sudah punya akun?</p>
    <div class="d-flex justify-content-center">
        <a href="#" class="btn btn-primary ">Login user</a>
    </div>
    <h1>Belum Punya akun? <a href="">Register</a> </h1>
</div>
...
<div class="row" style="height: 50vh;">
    ...
    <div class="col-12 ribbon-ligreen pt-5 pb-5">
        <div class="align-self-center">
            ...
            <p>Masuk sebagai tutor</p>
            <div class="d-flex justify-content-center">
                <a href="/mentor-register" class="btn btn-primary ">Login Tutor</a>
            </div>
            <h1>Belum Punya akun? <a href="">Register</a> </h1>
        </div>
    </div>
