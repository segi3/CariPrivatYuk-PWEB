...
<body>
    ...
    <!-- Navigation -->
    <nav id="navwhite" class="navbar fixed-top navbar-expand-lg fixed-top">
    <div class="container">
    ...
    <div class="row kursus-head">
        ...
        <div class="col-lg-5 parent-div">
            <div class="row child-div">
                ...
                <div class="col-12">
                    <img class="mr-2" src="../assets/main_resources/partner-logo.png" width="25px" alt=""><span id="partner-text">Partner Mentor</span>
                </div>
            </div>
        </div>
                        ...
                        <div class="card border-0">
                            <div class="card-body row">
                                <div class="col-3 d-flex justify-content-end align-items-center">
                                    <div>
                                        <img class="mr-2" src="../assets/main_resources/partner-logo.png" width="100px" alt="">
                                    </div>
