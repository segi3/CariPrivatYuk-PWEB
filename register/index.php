...
<head>
    ...
    <title>CariPrivatYuk! - Register</title>
...
<body>
    ...
    <div class="ribbon-yellow pt-5 pb-5">
        <h1 class="">Kursus Privat</h1>
        <p>Kami menyediakan privat bagi kalian yang sedang mencari tutor</p>
        <div class="d-flex justify-content-center">
            <a href="#" class="btn btn-primary ">Daftar Menjadi User!</a>
        </div>
        <p class="mt-3">Sudah punya akun? <a href="/KitaKursusKuy-PWEB/login/user">Login</a> </p>
    </div>


    <div class="row" style="height: 50vh;">

        <div class="col-12 ribbon-ligreen pt-5 pb-5">
            <div class="align-self-center">
                <h1 class="">Berbagi ilmu dengan semua orang!</h1>
                <p>Daftar menjadi tutor</p>
                <div class="d-flex justify-content-center">
                    <a href="#" class="btn btn-primary ">Daftar tutor!</a>
                </div>
                <p class="mt-3">Sudah punya akun? <a href="/KitaKursusKuy-PWEB/login/tutor">Login</a> </p>
            </div>
        </div>
    </div>
