        ...
        <div class="col-lg-4 parent-div">
            <div class="row child-div">
                <div class="col-12">
                    ...
                    <form method="POST" action="http://127.0.0.1:8000/user-register" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="8DvzUWwZHqPd4WWWQagoTWfikvIXqDmIQbKjmqkP">                    <div class="form-group"> 
