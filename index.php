        ...
        <div class="row pt-5">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <img style="width: 100%;"
                            src="assets/main_resources/home/svg/undraw_quitting_time_dm8t.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row" id="kurus-pop">
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="kursus/1"><img class="card-img-top" src="assets/main_resources/kursus/thumbnail/fotografi.png" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="kursus/2"><img class="card-img-top" src="assets/main_resources/kursus/thumbnail/jepang.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="kursus/3"><img class="card-img-top" src="assets/main_resources/kursus/thumbnail/deep-learning.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="kursus/4"><img class="card-img-top" src="assets/main_resources/kursus/thumbnail/ppt.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="kursus/5"><img class="card-img-top" src="assets/main_resources/kursus/thumbnail/art.png" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="kursus/6"><img class="card-img-top" src="assets/main_resources/kursus/thumbnail/gitar.jpg" alt=""></a>
                <div class="card-body">
...
<div class="container" id="mentor-pop">
    ...
    <div class="row" id="kurus-pop">
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="/privat/1"><img class="card-img-top" src="assets/main_resources/kursus/mentor/1.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="/privat/2"><img class="card-img-top" src="assets/main_resources/kursus/mentor/2.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="/privat/3"><img class="card-img-top" src="assets/main_resources/kursus/mentor/3.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="/privat/4"><img class="card-img-top" src="assets/main_resources/kursus/mentor/4.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="/privat/5"><img class="card-img-top" src="assets/main_resources/kursus/mentor/5.jpg" alt=""></a>
                <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 border-0">
                <a href="/privat/6"><img class="card-img-top" src="assets/main_resources/kursus/mentor/6.jpg" alt=""></a>
                <div class="card-body">
